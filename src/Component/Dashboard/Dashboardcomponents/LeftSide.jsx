              ...
              <li>
                <div className="dropdown">
                  ...
                  >
                    ...
                    <span>Chat</span>
                    <i className={`${activeDropdown === "widget" ? "up" : "down"} ml-2`}></i>
                  </a>
                  <ul
                    className={`dropdown-menu ${
              ...
              <li>
                <div className="dropdown">
                  ...
                  >
                    ...
                    <i className={`${activeDropdown === "artist-management" ? "up" : "down"} ml-2`}></i>
                  </a>
                  <ul
                    className={`dropdown-menu ${
                  ...
                  >
                    ...
                    <li>
                      <Link to="/tableManagement">Artist 
                      Artist Management</Link>
                    </li>
                  </ul>
                </div>
              </li>
              <li>
                <div className="dropdown">
                  ...
                  >
                    ...
                    <i className={`${activeDropdown === "Documentation" ? "up" : "down"} ml-2`}></i>
                  </a>
                  <ul
                    className={`dropdown-menu ${
